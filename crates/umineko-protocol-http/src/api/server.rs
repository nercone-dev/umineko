...
impl Default for HTTPServerConfig {
    fn default() -> Self {
        Self {
            ...
            tls_groups: [TLSGroup::X25519MLKEM768, TLSGroup::SECP384R1MLKEM1024, TLSGroup::SECP256R1MLKEM768, TLSGroup::X25519, TLSGroup::SECP256R1, TLSGroup::SECP384R1].to_vec(),
            tls_ciphers: [TLSCipher::TLS_AES_256_GCM_SHA384, TLSCipher::TLS_AES_128_GCM_SHA256, TLSCipher::TLS_CHACHA20_POLY1305_SHA256, TLSCipher::TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, TLSCipher::TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384].to_vec(),
