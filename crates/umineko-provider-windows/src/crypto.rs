...
use alloc::vec::Vec;
use crate::windows::WindowsProvider;

impl CipherProvider for WindowsProvider {
...
impl SignatureProvider for WindowsProvider {
...
impl ExchangeProvider for WindowsProvider {
...
impl KDFProvider for WindowsProvider {
